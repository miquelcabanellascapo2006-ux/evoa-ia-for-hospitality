    ...
    <section id="inicio" className="relative min-h-screen bg-white flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
          Somos la agencia especializada en soluciones de IA para PYMEs del sector hostelero. 
          Automatizamos procesos, optimizamos operaciones y mejoramos la experiencia del cliente.
        </p>
